...
var alcoholCostml = function alcoholCostml(formData) {
  var amtUsed = formData.amtUsed;
  var sizeOfBottle = formData.sizeOfBottle;
  ...
  var costPerMl = formData.costOfBottle / sizeOfBottle;
...
var onCalculate = function onCalculate(event) {
  ...
  console.log(data);
  var amtUsed = data.amtUsed * 1;
  var sizeOfBottle = data.sizeOfBottle * 1;
  if (data.usedUnit === 'oz') {
    amtUsed = amtUsed * 29.57;
  }
  ...
  if (amtUsed > sizeOfBottle) {
    ...
    var alertMessage = $('#amountTooLargeMessage');
    ...
    var _alertMessage = $('#incorrectInformationMessage');
    _alertMessage.removeClass('hide');
    _alertMessage.fadeTo(3000, 500).slideUp(500, function () {
      _alertMessage.slideUp(500);
    });
  }
};

var addIngredientToTotal = function addIngredientToTotal(event) {
  event.preventDefault();
...
var clearDrinkCost = function clearDrinkCost() {
  $('#drinkCost').text('0');
  store.total = 0;
};
